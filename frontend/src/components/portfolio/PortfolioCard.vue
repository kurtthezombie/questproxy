...
<template>
    <div class="flex justify-center">
        <div
            ...
            <div class="flex justify-center rounded-md">
                ...
                <div class="absolute top-2 right-2 flex space-x-2">
                    <button class="p-2 bg-gray-400 text-white rounded-md shadow-md hover:bg-blue-700 transition">
        ...
        <!-- Image Preview Modal -->
        <div v-if="showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-90">
            <div class="relative p-4 rounded-lg shadow-lg max-w-3xl">
                <button @click="closeModal"
                    class="absolute top-5 right-5 text-gray-500 p-3 text-2xl font-bold hover:bg-gray-400 hover:bg-opacity-30 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
