    ...
    <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0"
      ...
      <div v-if="isModalOpen" class="fixed inset-0 bg-black bg-opacity-60 z-40 flex items-center justify-center p-4">
        <div class="bg-[#1E293B] rounded-lg shadow-xl max-w-md w-full overflow-hidden border border-gray-700 text-white"
          ...
          <div class="p-4 sm:p-6 border-b border-gray-700 flex items-start justify-between">
            <h3 class="text-lg font-semibold text-white">Report Details</h3>
            <button @click="closeModal"
              class="text-gray-400 hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-600 rounded-full p-1">
