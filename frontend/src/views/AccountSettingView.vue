      ...
      <div class="w-full md:w-[240px] space-y-6">
        ...
        <div class="bg-[#1E293B] rounded-lg p-4 border border-gray-700">
          <nav class="space-y-4 text-xs">
            ...
            <a href="#" class="flex justify-start gap-2 text-green-400 font-medium">
              <i class="fas fa-id-card-alt"></i> Personal Information
            </a>
          </nav>
        <!-- Sign Out (placed below Personal Information) -->
        <div class="mt-4">
          <nav class="space-y-4 text-xs">
            <a href="#" @click="callLogout" class="flex justify-start gap-2 text-red-500 hover:text-red-600">
