...
<template>
  ...
  <div class="min-h-screen bg-gray-900 flex items-center justify-start text-white flex-col">
    <div class="fixed top-0 left-0 w-full bg-gray-900 z-10 py-4 flex flex-col items-center" style="margin-top: 64px;">
    ...
    <div class="pt-32 w-full flex flex-col items-center">
